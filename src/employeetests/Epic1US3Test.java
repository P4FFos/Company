...
public class Epic1US3Test {
    ...
    public void shouldCreateManagerEmployee() throws Exception {
        ...
        String expectedMessage = "Company.Employee.Employee IDb was registered successfully.";
    ...
    public void shouldCreateDirectorEmployee() throws Exception {
        ...
        String expectedMessage = "Company.Employee.Employee IDc was registered successfully.";
        ...
        expectedMessage = "Company.Employee.Employee IDd was registered successfully.";
        ...
        expectedMessage = "Company.Employee.Employee IDe was registered successfully.";
    ...
    public void shouldCreateInternEmployee() throws Exception {
        ...
        String expectedMessage = "Company.Employee.Employee IDf was registered successfully.";
        ...
        expectedMessage = "Company.Employee.Employee IDg was registered successfully.";
        ...
        expectedMessage = "Company.Employee.Employee IDh was registered successfully.";
