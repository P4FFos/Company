...
public class Epic1US9Test {
    ...
    public void shouldUpdateEmployee() throws Exception {
        assertEquals("Company.Employee.Employee Emp6 was updated successfully", facade.updateEmployeeName("Emp6", "Candy Ferocity"));
        assertEquals("Company.Employee.Employee Emp6 was updated successfully", facade.updateInternGPA("Emp6", 10));
        assertEquals("Company.Employee.Employee Emp4 was updated successfully", facade.updateInternGPA("Emp4", 2));
        assertEquals("Company.Employee.Employee Emp1 was updated successfully", facade.updateManagerDegree("Emp1", "PhD"));
        assertEquals("Company.Employee.Employee Emp1 was updated successfully", facade.updateDirectorDept("Emp1", "Technical"));
        assertEquals("Company.Employee.Employee Emp8 was updated successfully", facade.updateGrossSalary("Emp8", 15000.00));
        assertEquals("Company.Employee.Employee Emp3 was updated successfully", facade.updateGrossSalary("Emp3", 28000.99));
        assertEquals("Company.Employee.Employee Emp3 was updated successfully", facade.updateManagerDegree("Emp3", "MSc"));
