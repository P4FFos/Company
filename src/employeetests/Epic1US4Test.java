...
public class Epic1US4Test {
    ...
    public void shouldRemoveEmployee() throws Exception {
        String empID = "Emp8";
        String expectedMessage = "Company.Employee.Employee Emp8 was successfully removed.";
        String actualMessage = facade.removeEmployee(empID);
        assertEquals(expectedMessage, actualMessage);

        // Since it was removed you can create the Company.Employee.Employee with the ID again.
        String expectedLeiomy = "Company.Employee.Employee Emp8 was registered successfully.";
