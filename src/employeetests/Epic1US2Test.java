...
public class Epic1US2Test {
    ...
    public void shouldBeDifferentCompanies() throws Exception {
        ...
        String nancyMessage = "Company.Employee.Employee IDa was registered successfully.";
        ...
        String juneMessage = "Company.Employee.Employee IDa was registered successfully.";
